...
$filename = "admin/upload/". $_FILES['file']['name'];
$info = pathinfo($filename);
$file_name =  basename($filename,'.'.$info['extension']);
 require_once 'library/config.php';
				 $sql="INSERT INTO tbl_child_images (title,image) VALUES ('$title','$file_name')";
...
body {
 ...
 background-color:#999999 ;
    background:#999999 url() fixed repeat top left;
...
<?php echo $file_name;?></div>
  ...
  <div id="container" >
   ...
   <div id="con">
		...
		<a href="http://mactimeline.com/beta1.1">Back</a>
      </table>
				</form>
