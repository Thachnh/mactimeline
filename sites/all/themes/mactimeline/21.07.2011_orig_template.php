...
//$variables['form']['name']['#attributes']['onfocus'] = "if (this.value == '".$variables['form']['name']['#value']."') {this.value = '';} ;";
  ...
  $variables['form']['name']['#size'] = 10;
  $variables['form']['pass']['#size'] = 10;
  ...
  if (variable_get('user_register', 1)) {
    $items[] = l(t('NEW USER'), 'user/register', array('attributes' => array('title' => t('Create new account'))));
  }
  $items[] = l(t('FORGOT'), 'user/password', array('attributes' => array('title' => t('Request new password'))));
